    ...
    methods: {
        ...
        generatepdf(){
          ...
          if(this.printfrom=='BARANGY CLEARANCE'){
            ...
            pdf.setFontSize(11);
            pdf.text('Republic of the Philippines', 81,30);
            pdf.text('PROVINCE OF LANAO DEL NORTE', 72,34);
            pdf.text('Municipality of Salvador', 82,38);
            pdf.text('Barangay Panaliwad-on', 83,42);

            pdf.setFontSize(12);
            pdf.text('OFFICE OF THE BARANGAY CAPTAIN', 65,57);

            pdf.setFontSize(24);
            pdf.text('BARANGAY CLEARANCE', 55,75);
            ...
            pdf.text('PRINTING '+this.printfrom, 10,10);
            pdf.save(this.printfrom+'.pdf');
          }
        }
    }
